  ...
  >
    <div class="card-body p-15 p-sm-20 p-md-25 p-lg-30">
      <div class="profile-info d-sm-flex align-items-center">
        <img
          src="../../../assets/images/user/user-dummy.png"
          class="rounded"
          alt="user"
        />
        <div class="title mt-12 mt-sm-0">
          ...
          <span class="d-block fw-bold text-primary">Adlash IT Solution</span>
        </div>
      </div>
      <div
      ...
      <ul class="info mt-25 ps-0 mb-0 list-unstyled">
        ...
        <li class="position-relative">
          ...
          <span class="d-block text-black mb-5 fw-semibold">Referral Code</span>
